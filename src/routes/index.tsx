...
export default component$(() => {
	...
	return (
		<>
			...
			<div class='z-10 row-span-2 m-auto grid h-full w-full max-w-screen-xl gap-4 px-4 md:px-10 lg:absolute lg:left-0 lg:right-0 lg:top-0 lg:grid-cols-2 lg:px-24'>
